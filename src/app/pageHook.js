      ...
      <section className=" mt-5  ">
        <div className="space-y-4 ">
          <div className="space-y-2 text-center">
            ...
            <h1 className="text-3xl font-bold  sm:text-5xl xl:text-6xl/none bg-clip-text text-transparent dark:bg-gradient-to-r bg-gradient-to-tr dark:from-white from-black to-neutral-600 dark:to-neutral-100 capitalize md:max-w-2xl lg:max-w-3xl mx-auto ">
              Join The Waitlist!
            </h1>
            <p className="max-w-[600px]  leading-7 text-center text-[16px] bg-clip-text text-transparent dark:bg-gradient-to-br bg-gradient-to-tr dark:from-white from-black to-neutral-600 dark:to-neutral-200 mx-auto ">
              This App that will help show you all the different companys to
              support all your hobbies <br />
             Waitlisted users will be the first to be notified when we launch!
            </p>
            {errors.email && (
